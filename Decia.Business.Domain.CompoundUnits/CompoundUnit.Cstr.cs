...
namespace Decia.Business.Domain.CompoundUnits
{
    public partial class CompoundUnit
    {
        ...
        public static readonly string SP_ReadCurrent_Name = ClassReflector.GetPropertyName<string>(() => SqlResources.Decia_CompoundUnits_ReadCurrent);
        ...
        public const string SP_ReadCurrent_Parameter2_Name = "compoundUnitGuidsAsText";
        ...
        public static void CreateSqlObjects(IDomainModel domainModel, bool forceCreation)
        {
            ...
            {
                sqlConnection.CreateOrUpdateStoredProcedure(SP_ReadCurrent_Name, SqlResources.Decia_CompoundUnits_ReadCurrent);
            }
