...
{
    public partial class RowHeader : ReportElementBase<RowHeader>, IRowHeader
    {
        ...
        public RowHeader(ReportId reportId)
            : this(reportId.ProjectGuid, reportId.RevisionNumber_NonNull, reportId.ModelTemplateNumber, reportId.ReportGuid)
        { }

        public RowHeader(Guid projectGuid, long revisionNumber, int modelTemplateNumber, Guid reportGuid)
        ...
        {
            return ReportElementType_New.DimensionalTable_RowHeader;
        }
        ...
        #region IRowHeader Implementation
