...
namespace Decia.Business.Domain.Reporting
{
    public partial class VariableTitleContainer
    {
        ...
        public static readonly VariableTitleContainerEditabilitySpecification EditabilitySpec = new VariableTitleContainerEditabilitySpecification();
        ...
        public static readonly DimensionLayout DefaultLayout_X = new DimensionLayout(Dimension.X)
        {
            ...
            ContainerMode_Value = (ITransposableElementUtils.Default_StackingDimension == Dimension.X) ? ContainerMode.Grid : ContainerMode.Single,
        ...
        public static readonly DimensionLayout DefaultLayout_Y = new DimensionLayout(Dimension.Y)
        {
            AlignmentMode_Value = AlignmentMode.Stretch,
            SizeMode_Value = SizeMode.Auto,
            ContainerMode_Value = (ITransposableElementUtils.Default_StackingDimension == Dimension.Y) ? ContainerMode.Grid : ContainerMode.Single,
            MinRangeSizeInCells_Value = 1,
            Margin_Value = new DimensionStyleValue<int>(0, 0),
            Padding_Value = new DimensionStyleValue<int>(0, 0),
        ...
        {
            BackColor_Value = new ColorSpecification(Color.LightBlue),
        ...
        #region VariableTitleContainerEditabilitySpecification Inner Class

        public class VariableTitleContainerEditabilitySpecification : IOverridableEditabilitySpecification
        {
            internal const EditMode DefaultMode = IEditabilitySpecificationUtils.DefaultEditMode;

            public VariableTitleContainerEditabilitySpecification()
