...
namespace Decia.Business.Domain.Reporting
{
    public partial class ColumnHeader
    {
        ...
        internal const int Default_MinimumWidth = 1;
        internal const int Default_MinimumHeight = 1;

        public static readonly IEditabilitySpecification EditabilitySpec = new ColumnHeaderEditabilitySpecification();
        ...
        #region ColumnHeaderEditabilitySpecification Inner Class

        public class ColumnHeaderEditabilitySpecification : IEditabilitySpecification
        {
