...
namespace Decia.Business.Domain.Reporting
{
    public partial class VariableTitleBox
    {
        ...
        public static readonly VariableTitleRangeEditabilitySpecification EditabilitySpec = new VariableTitleRangeEditabilitySpecification();
        ...
        #region VariableTitleRangeEditabilitySpecification Inner Class

        public class VariableTitleRangeEditabilitySpecification : IOverridableEditabilitySpecification
        {
            internal const EditMode DefaultMode = IEditabilitySpecificationUtils.DefaultEditMode;

            public VariableTitleRangeEditabilitySpecification()
