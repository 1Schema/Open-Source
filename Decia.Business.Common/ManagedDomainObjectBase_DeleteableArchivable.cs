...
{
    public abstract class ManagedDomainObjectBase_DeleteableArchivable<KEY, KEYED_DOMAIN_OBJECT> : ManagedDomainObjectBase_Deleteable<KEY, KEYED_DOMAIN_OBJECT>, IArchivable
        where KEYED_DOMAIN_OBJECT : class, IKeyedDomainObject<KEY, KEYED_DOMAIN_OBJECT>, IPermissionable, IDeletable, IArchivable
    {
        ...
        public ManagedDomainObjectBase_DeleteableArchivable()
            : this(UserState.CurrentThreadState.CurrentUserId)
        { }

        public ManagedDomainObjectBase_DeleteableArchivable(IUser creator)
            : this(creator.UserGuid)
        { }

        public ManagedDomainObjectBase_DeleteableArchivable(Guid creatorGuid)
            : base(creatorGuid)
        {
            m_IsArchived = false;
            m_ArchiverGuid = null;
        ...
        protected override void CopyBaseValuesTo(KEYED_DOMAIN_OBJECT otherObject)
        {
            ...
            var otherObject_Typed = (otherObject as ManagedDomainObjectBase_DeleteableArchivable<KEY, KEYED_DOMAIN_OBJECT>);
