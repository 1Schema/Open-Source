...
namespace Decia.Business.Common.Collections
{
    ...
    public class ReadOnlySortedDictionary<TKey, TValue> : IReadOnly, IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IDictionary, ICollection, IEnumerable
    {
        ...
        [TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
        public ReadOnlySortedDictionary(IDictionary<TKey, TValue> dictionary)
        {
            m_IsReadOnly = false;
            m_Dictionary = new SortedDictionary<TKey, TValue>(dictionary);
        }

        public ReadOnlySortedDictionary(IComparer<TKey> comparer)
        {
            m_IsReadOnly = false;
            m_Dictionary = new SortedDictionary<TKey, TValue>(comparer);
        }

        public ReadOnlySortedDictionary(IDictionary<TKey, TValue> dictionary, IComparer<TKey> comparer)
        {
            m_IsReadOnly = false;
        ...
        public IComparer<TKey> Comparer { get { return m_Dictionary.Comparer; } }
        ...
        public SortedDictionary<TKey, TValue>.KeyCollection Keys { get { return m_Dictionary.Keys; } }
        public SortedDictionary<TKey, TValue>.ValueCollection Values { get { return m_Dictionary.Values; } }
        ...
        #region Methods - To mirror SortedDictionary<TKey, TValue>
