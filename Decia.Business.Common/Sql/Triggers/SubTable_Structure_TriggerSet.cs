...
{
    public class SubTable_Structure_TriggerSet
    {
        public const string NamePartSpacer = GenericDatabaseUtils.NamePartSpacer;
        public const string NamePrefix = "SUB_STRUCTURE";
        ...
        public SubTable_Structure_TriggerSet(GenericTable parentTable, Guid constrainedColumnId)
        {
            ...
            foreignKey.ConstraintSource = ForeignKey_Source.SubStructure;
        }
        ...
        public string ExportToScript(SqlDb_TargetType dbType)
        {
            if (dbType == SqlDb_TargetType.MsSqlServer)
            {
                ...
                if (foreignKey.ConstraintSource != ForeignKey_Source.SubStructure)
