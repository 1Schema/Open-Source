...
{
    public abstract class ModelDomainObjectBase_Taggable<KEY, KEYED_DOMAIN_OBJECT> : ModelDomainObjectBase<KEY, KEYED_DOMAIN_OBJECT>, ITaggable
        where KEY : IModelMember
        where KEYED_DOMAIN_OBJECT : class, IKeyedDomainObject<KEY, KEYED_DOMAIN_OBJECT>, IModelMember, IPermissionable, ITaggable
    {
        ...
        public ModelDomainObjectBase_Taggable(IModelMember modelMember)
            : base(modelMember)
        { }

        public ModelDomainObjectBase_Taggable(Guid projectGuid, long revisionNumber, int modelTemplateNumber, Guid? modelInstanceGuid)
            : base(projectGuid, revisionNumber, modelTemplateNumber, modelInstanceGuid)
        { }

        public ModelDomainObjectBase_Taggable(IUser creator, IModelMember modelMember)
            : base(creator, modelMember)
        { }

        public ModelDomainObjectBase_Taggable(Guid creatorGuid, Guid projectGuid, long revisionNumber, int modelTemplateNumber, Guid? modelInstanceGuid)
        ...
        protected override void CopyBaseValuesTo(KEYED_DOMAIN_OBJECT otherObject)
        {
            ...
            var otherObject_Typed = (otherObject as ModelDomainObjectBase_Taggable<KEY, KEYED_DOMAIN_OBJECT>);
