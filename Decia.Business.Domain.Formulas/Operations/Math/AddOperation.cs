...
namespace Decia.Business.Domain.Formulas.Operations.Math
{
    public class AddOperation : OperationBase
    {
        ...
        public static readonly Signature Input_TimeSpan_TimeSpan_TimeSpan__Return_TimeSpan = new Signature(Parameters, new DeciaDataType[] { DeciaDataType.TimeSpan, DeciaDataType.TimeSpan, DeciaDataType.TimeSpan }, DeciaDataType.TimeSpan);
        public static readonly Signature Input_Text_Text_Text__Return_Text = new Signature(Parameters, new DeciaDataType[] { DeciaDataType.Text, DeciaDataType.Text, DeciaDataType.Text }, DeciaDataType.Text);
        ...
        public AddOperation()
        {
            ...
            m_ShortName = "ADD";
            m_LongName = "Add";
            m_Description = "Adds 2 or more values";
            ...
            validSignatures.Add(Input_TimeSpan_TimeSpan_TimeSpan__Return_TimeSpan);
            validSignatures.Add(Input_Text_Text_Text__Return_Text);
        ...
        protected override OperationMember DoCompute(IFormulaDataProvider dataProvider, ICurrentState currentState, IFormula parentFormula, IExpression callingExpression, IDictionary<int, OperationMember> inputs, OperationMember defaultReturnValue)
        {
            ...
            if (SignatureSpecification.IsSpecificInstanceOf(Input_Bool_Bool_Bool__Return_Bool, signature)
                || SignatureSpecification.IsSpecificInstanceOf(Input_Int_Int_Int__Return_Int, signature)
                ...
                || SignatureSpecification.IsSpecificInstanceOf(Input_TimeSpan_TimeSpan_TimeSpan__Return_TimeSpan, signature)
                || SignatureSpecification.IsSpecificInstanceOf(Input_Text_Text_Text__Return_Text, signature))
            {
