...
{
    public class LessThanOrEqualToOperation : OperationBase
    {
        ...
        public LessThanOrEqualToOperation()
        {
            m_Id = OperationCatalog.GetOperationId(this.GetType());
            m_ShortName = "LESS_EQLS";
            m_LongName = "Less Than or Equal To";
            m_Description = "Checks less than or equals for 2 values";
