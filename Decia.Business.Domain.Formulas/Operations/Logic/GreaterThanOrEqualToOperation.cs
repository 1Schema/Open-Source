...
{
    public class GreaterThanOrEqualToOperation : OperationBase
    {
        ...
        public GreaterThanOrEqualToOperation()
        {
            m_Id = OperationCatalog.GetOperationId(this.GetType());
            m_ShortName = "GRTR_EQLS";
            m_LongName = "Greater Than or Equal To";
            m_Description = "Checks greater than or equals for 2 values";
